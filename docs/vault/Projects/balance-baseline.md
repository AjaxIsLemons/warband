...
```
content.fingerprint                                                   a6d4b52f6b8d824f
...
enc.gnawing-hour.a2.control                                           win=100 spread=0 rule=100 ticks=167
...
enc.gnawing-hour.a3.control                                           win=100 spread=0 rule=100 ticks=184
...
enc.the-long-range.a1.control                                         win=0 spread=0 rule=0 ticks=139
...
enc.the-long-range.a2.control                                         win=100 spread=0 rule=0 ticks=287
...
enc.the-long-range.a3.control                                         win=100 spread=100 rule=0 ticks=322
...
enc.ninth-bell.a1.control                                             win=100 spread=0 rule=100 ticks=93
...
enc.ninth-bell.a3.control                                             win=100 spread=0 rule=100 ticks=222
...
enc.the-drop.a1.control                                               win=100 spread=0 rule=100 ticks=152
...
enc.the-drop.a2.control                                               win=100 spread=0 rule=100 ticks=134
...
enc.the-drop.a3.control                                               win=100 spread=0 rule=100 ticks=136
...
enc.slagworks.a2.control                                              win=100 spread=0 rule=100 ticks=261
...
enc.slagworks.a3.control                                              win=100 spread=100 rule=100 ticks=267
...
enc.long-procession.a1.control                                        win=100 spread=0 rule=100 ticks=135
...
enc.long-procession.a2.control                                        win=100 spread=0 rule=67 ticks=142
...
boss.a2.control                                                       win=100 spread=100 rule=100 ticks=373
...
boss.a3.control                                                       win=100 spread=100 rule=100 ticks=400
...
build.class.banneret                                                  avg=12 best=17 worst=5
...
run.stable                                                            victory=2 fightwin=75 boss=0.41 gold=17 caps=0
run.fraying                                                           victory=4 fightwin=76 boss=0.53 gold=20 caps=0
run.collapsing                                                        victory=8 fightwin=77 boss=0.57 gold=26 caps=0
build.flags                                                           8
build.flag                                                            CHASSIS-DEAD banneret (best build 17%)
