...
| UI Toolkit, UXML/USS, HUDs, menus | `.claude/skills/unity-ui/SKILL.md`; add `unity-ui-patterns` for architecture |
...
| Audio, mixers, spatial audio | `.claude/skills/unity-audio/SKILL.md` |
